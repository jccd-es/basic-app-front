...
const Locations = async(() => import("@/pages/app/locations/Locations"));
const SesSettings = async(() => import("@/pages/app/ses-hospedajes/SesSettings"));
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "ses-hospedajes/reports",
        element: <Blank />,
      },
      {
        path: "ses-hospedajes/settings",
        element: <SesSettings />,
      },
      {
        path: "ses-hospedajes/docs",
        element: <Blank />,
      },
      {
        path: "ses-hospedajes/help",
        element: <Blank />,
      },
      {
        path: "vehicles/list",
